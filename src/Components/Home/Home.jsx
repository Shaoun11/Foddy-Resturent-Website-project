    ...
    return (
        <div>
           ...
           <Slider></Slider> 
            ...
            <div>
                <h1 className='font-bold lg:text-6xl md:text-6xl text-5xl text-center mt-20 mb-16'>Our <span className='text-red-500'>Top</span> Selling <span className='text-red-500'>Food</span></h1>
            </div>
